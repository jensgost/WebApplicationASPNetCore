...
namespace WebApplicationASPNetCore.Controllers
{
    public class OrganizersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,PhoneNumber")] Organizer organizer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,PhoneNumber")] Organizer organizer)
        {
            if (id != organizer.Id)
            {
                return NotFound();
